...
class Captcha
{
    ...
    public function __construct($level = 2, $caseSensitive = false)
    {
      ...
      //  $this->font = 'arial.ttf';
      //  $this->font = 'c:/laragon/www/captcha4/arial.ttf';

        // create image
        $this->imageResource = imagecreate(200, 77);
        imagecolorallocate($this->imageResource, 255, 255, 255);

        //$text_color = imagecolorallocate($this, 233, 14, 91);
        //imagestring($this, 1, 5, 5,  "A Simple Text String", $text_color);

   // $black = ImageColorAllocate($this,0x00,0x00,0x00); 
     //   ImageFilledRectangle($this,50,50,150,150,$black); 
    //  ImageString($this,5,50,160,"A Black Box",$black); 
